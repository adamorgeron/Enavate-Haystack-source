...
-Added new report "Nightowl Sales Inv By Desc"
...
*/
report 50004 "NightOwl Sales Inv. VAT.NOWL"
{
    // RDLCLayout = './Objects/Report/Layout/REP50000.NightOwl Sales Invoice by Work.NOWL.rdlc';
    WordLayout = './Objects/Report/Layout/REP50004.NightOwl Sales Invoice by Description VAT.NOWL.docx';
    Caption = 'NightOwl Sales Invoice for VAT';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(SalesHeadBillingRefDesc; SalesHeadBillingRefDesc)
            {
            ...
            column(YourReference2_Header; "Your Reference 3.NOWL")  // NIGHT0011
            {

            }
            column(YourReference2_Header_Lbl; FIELDCAPTION("Your Reference 3.NOWL"))  // NIGHT0011
            {
            }
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(Your_Reference_2_NOWL_Line; "Your Reference 3.NOWL")  // NIGHT0011
                {
                ...
                column(Your_Reference_2_NOWL_Line_Label; Line.FieldCaption("Your Reference 3.NOWL"))  // NIGHT0011
                {
                ...
                {
                    DataItemTableView = SORTING("Document Type", "No.", "Document Line No.", "Line No.") WHERE("Document Type" = CONST("Posted Invoice"), "Print On Invoice" = filter(true));
    ...
    var
        ...
        //Language: Record "Language";  // NOWL00007 - Removed
        ...
        SalesHeadBillingRefDesc: Text[50];
        ...
        LineForDesc: Record "Sales Invoice Line";
    ...
    // NIGHT0006
    local procedure InsertSalesInvCommentLines(InvoiceLine: Record "Sales Invoice Line")
    var
        IntLineNo: Integer;
    begin
        Line.RESET;
        ...
        //   IntLineNo := LineNo + 1;
        SalesInvLineComments.RESET;
        SalesInvLineComments.SETRANGE(SalesInvLineComments."Document Type", SalesInvLineComments."Document Type"::"Posted Invoice");
