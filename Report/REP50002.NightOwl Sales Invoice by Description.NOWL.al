...
*/
report 50002 "NightOwl Sales Invoice.NOWL"
{
    // RDLCLayout = './Objects/Report/Layout/REP50000.NightOwl Sales Invoice by Work.NOWL.rdlc';
    WordLayout = './Objects/Report/Layout/REP50002.NightOwl Sales Invoice by Description.NOWL.docx';
    Caption = 'NightOwl Sales Invoice By Description';
    DefaultLayout = Word;
                ...
                */
                ...
                IF InvLine.FindSet() then
                    repeat
                        ...
                        Line.SetRange("Unit of Measure Code", InvLine."Unit of Measure Code");//ADAMO240210
